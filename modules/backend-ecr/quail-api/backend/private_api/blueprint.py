...
def register_routes(blueprint):
    ...
    blueprint.add_url_rule(
        "/waitForUpdateCompletion", "wait-for-update-completion", view_func=views.get_wait_for_update_completion
    )
    blueprint.add_url_rule("/updateComplete", "update-complete", view_func=views.post_update_complete, methods=["post"])
    blueprint.add_url_rule("/updateFailure", "update-failure", view_func=views.post_update_failure, methods=["post"])
