...
DYNAMODB_REGIONAL_METADATA_TABLE_NAME = env.str(
...
UPDATE_SFN_ARN = env.str("UPDATE_SFN_ARN")
...
STACK_SET_EXECUTION_ROLE_NAME = env.str("STACK_SET_EXECUTION_ROLE_NAME")
STACK_SET_ADMIN_ROLE_ARN = env.str("STACK_SET_ADMIN_ROLE_ARN")

CLEANUP_NOTICE_NOTIFICATION_HOURS = env.str(
    "CLEANUP_NOTICE_NOTIFICATION_HOURS"
)  # noqa: F405
